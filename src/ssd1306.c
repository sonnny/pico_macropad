...
void ssd1306_update(uint8_t map){
  switch(map){
	  case 0: WriteString(0,10,"VOLUME"); break;
		case 1: WriteString(0,20,"CUT PASTE"); break;
		case 2: WriteString(0,30,"CAPITAL"); break;
		case 3: WriteString(0,40,"SMALL"); break;}}	
